...
class ClassroomController extends Controller
{
    ...
    {
        $classroom = $request->except('_token');
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(/*Request*/ UpdateClassroomRequest $request, /*Classroom $classroom*/ $id)
    {
        $classroom = $request->except('_token', '_method');
        Classroom::where('id', '=', $id)->update($classroom);
