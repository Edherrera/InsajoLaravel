                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        @forelse (auth()->user()->unreadNotifications as $notification)
                            <a href="#" class="dropdown-item disabled">
                                ...
                                <span class="float-right text-muted text-sm">{{ $notification->created_at->toDateTimeString() }}</span>
                            </a>
                        @empty
                            <span class="dropdown-item dropdown-header disabled">No tiene notificaciones</span>
                        @endforelse
